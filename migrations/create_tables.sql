...
CREATE TABLE
    IF NOT EXISTS `stage_numero_egresados_internacional` (
        `year` INT,
        `country` VARCHAR(255),
        `num_graduated_M` INT,
        `num_graduated_F` INT,
...
CREATE TABLE
    IF NOT EXISTS `stage_porcentaje_egresados_internacional` (
        `year` INT,
        `country` VARCHAR(255),
...
CREATE TABLE
    IF NOT EXISTS `stage_situacion_laboral_egresados` (
        `año` INT,
        `pais` VARCHAR(255),
...
CREATE TABLE
    IF NOT EXISTS `stage_egresados_niveles` (
        `año` INT,
        `pais` VARCHAR(255),
...
CREATE TABLE
    IF NOT EXISTS `stage_egresados_universidad` (
        `año` INT,
        `pais` VARCHAR(255),
...
CREATE TABLE
    IF NOT EXISTS `stage_ramas_conocimiento` (
...
CREATE TABLE
    IF NOT EXISTS `dimm_tipo_universidad` (
        `id` INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS `dimm_universidades` (
        `id` INTEGER AUTO_INCREMENT PRIMARY KEY,
        `nombre_universidad` VARCHAR(255),
        `tipo_universidad` VARCHAR(255),
        `modalidad` VARCHAR(255)
...
CREATE TABLE
    IF NOT EXISTS `dimm_rama_enseñanza` (
        `id` INTEGER PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS `dimm_ambito_enseñanza` (
        `id` VARCHAR(255),
...
CREATE TABLE
    IF NOT EXISTS `dimm_situacion_laboral` (
        `id` INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS `fact_international_graduated` (
        `year` INT NOT NULL,
        `id_country` INT,
...
CREATE TABLE
    IF NOT EXISTS `fact_situacion_laboral_egresados` (
        `año` INT NOT NULL,
        `id_pais` INT,
...
CREATE TABLE
    IF NOT EXISTS `fact_egresados_rama_enseñanza` (
        `año` INT NOT NULL,
        `id_pais` INT,
        `id_universidad` INT,
...
CREATE TABLE
    IF NOT EXISTS `fact_egresados_niveles` (
        `año` INT NOT NULL,
        `id_pais` INT,
